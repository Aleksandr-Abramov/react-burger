    ...
    <div className="wrapper">
      <nav className="nav">
        <ul className={ styles.menu }>
          <li className={`${styles.menuItem}`}><a href="/" className={ styles.menuLink }><BurgerIcon type="secondary"/><span className={`text text_type_main-default text_color_inactive pl-2`}>Конструктор</span></a></li>
